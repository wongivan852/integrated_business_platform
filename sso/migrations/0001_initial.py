...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name="ssotoken",
            index=models.Index(
                fields=["jti", "is_active"], name="sso_ssotoke_jti_8d5f01_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ssotoken",
            index=models.Index(
                fields=["user", "is_active"], name="sso_ssotoke_user_id_ba0795_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ssosession",
            index=models.Index(
                fields=["user", "is_active"], name="sso_ssosess_user_id_954cdf_idx"
            ),
        ),
        migrations.AddIndex(
            model_name="ssosession",
            index=models.Index(
                fields=["token", "is_active"], name="sso_ssosess_token_i_803dad_idx"
            ),
        ),
        migrations.AddIndex(
            ...
            index=models.Index(
                ...
                name="sso_ssoaudi_user_id_ca6c60_idx",
            ),
        ),
        migrations.AddIndex(
            model_name="ssoauditlog",
            index=models.Index(
                ...
                name="sso_ssoaudi_event_t_ee1fad_idx",
            ),
        ),
    ]
